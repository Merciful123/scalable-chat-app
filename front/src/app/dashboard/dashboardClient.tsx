...
export default function DashboardClient({
  ...
  return (
    ...
    <div>
      ...
      <p className="mt-5 text-center text-xl bg-linear-to-r from-pink-400 to-purple-600 bg-clip-text text-transparent">Welcome to your dashboard. Manage your chat groups, conversations, and real-time activity all in one place.</p>
